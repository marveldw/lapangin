...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full bg-white">
      ...
      <div className="relative w-full min-h-[460px] sm:min-h-[520px] lg:min-h-[560px] flex flex-col justify-center pt-32 sm:pt-36 lg:pt-40 pb-16 sm:pb-20 bg-[#0b1c30] text-white overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none select-none">
          ...
          />
          {/* Left-to-right gradient: dark on left for high-contrast text, transparent on right */}
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#0b1c30]/80 via-transparent to-[#0b1c30]/85" />
        </div>

        {/* Hero Left Content (Bebas dari tabrakan Navbar) */}
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col items-start text-left">
          {/* Headline */}
          <h1 className="text-3xl sm:text-5xl lg:text-[54px] font-black text-white tracking-tight leading-[1.15] mb-4 max-w-2xl drop-shadow-md">
      ...
      {/* 2. Search Bar Area (Diposisikan Rapi Tepat di Bawah Foto) */}
      <div className="relative z-20 w-full bg-white pt-8 pb-4">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-[#006e2f] text-white rounded-2xl md:rounded-full shadow-xl shadow-emerald-950/15 p-2 sm:p-2.5 border border-emerald-500/40">
      ...
      <div className="w-full pt-8 pb-12 sm:pb-14 bg-white border-b border-gray-100">
